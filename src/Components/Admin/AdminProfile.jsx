                ...
                <div className='pb-10 pt-7 mt-[73px] flex items-center relative'>
                    ...
                    {isLoading ? (
                        ...
                        <div className=' relative rounded-full w-[150px] h-[150px]'>
                            <img src={admin?.role ? admin?.photo :"https://i.pinimg.com/236x/01/21/8b/01218b1a1560ca260596cd19c14fb1d9.jpg"} alt="" className=' rounded-full w-[150px] h-[150px] object-cover'/>
