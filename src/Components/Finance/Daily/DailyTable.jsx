    ...
    <table className=" text-white table-responsive2 w-full">
            <thead className=" tracking-wider text-sm border border-[#7E7F80]">
              <tr>
                ...
                <th className="p-4 max-[1000px]:pr-16 text-start">ITEM COUNT</th>
                <th className="p-4 max-[1000px]:pr-10 text-start">CASH</th>
              ...
              {Daily?.map((pd) => {
                return (
                  ...
                  >
                    ...
                    <td onClick={() => route(pd?.id)} className=" cursor-pointer p-4 text-start">{pd?.item}</td>
                    <td onClick={() => route(pd?.id)} className=" cursor-pointer p-4 text-start">{pd?.cash}</td>
                    ...
                    <td className="p-4 justify-center flex gap-3 items-center overflow-hidden">
                      <span><BsArrowRightShort className='icon'/></span>
                    </td>
                  </tr>
                );
              })}
