              ...
              {yearlyTable?.map((pd) => {
                return (
                  ...
                  >
                    ...
                    <td className=" p-4 text-start">{pd?.created_at}</td>
                    <td className=" p-4 text-start">{pd?.total_voucher}</td>
                    <td className=" p-4 text-end">{pd?.total_cash}</td>
                    <td className=" p-4 text-end">{pd?.tax_total}</td>
