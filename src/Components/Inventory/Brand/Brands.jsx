...
const Brands = () => {
  ...
  useEffect(() => {
    localStorage.setItem("brandPage", page);
  }, [page]);
    ...
    <MainLayout>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className=" flex justify-between items-center max-[680px]:flex-col max-[680px]:items-start max-[680px]:gap-3 ">
                  <form className="relative">
                    <input
                      onChange={(e) => dispatch(setSearchBrand(e.target.value))}
                      type="text"
                      placeholder="Search"
                    ...
                    <table className=" text-white max-[865px]:whitespace-nowrap max-[865px]:block max-[865px]:overflow-x-auto w-full">
                      <thead className=" tracking-wider text-sm border border-[#7E7F80]">
                        <tr>
                          ...
                          <th className="p-4 max-[1000px]:pr-12 text-start">
                            BRAND NAME
                          </th>
                          <th className="p-4 max-[1000px]:pr-12 text-start">
                            COMPANY NAME
                          ...
                          <th className="p-4 max-[1000px]:pl-12 text-end ">
                            PHONE
                          </th>
                          <th className="p-4 max-[1000px]:pr-12 text-start">
                            DESCRIPTION
      ...
      {id != null && (
        <EditBrand
          ...
          setEditSidebarOpen={setEditSidebarOpen}
          id={id}
          setId={setId}
        />
      )}
